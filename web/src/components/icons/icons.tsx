  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.2849 23.4256L0 12.0656L11.4152 0.574451C12.1761 -0.191484 13.4097 -0.191483 14.1706 0.57445C14.9315 1.34038 14.9315 2.58221 14.1706 3.34814L5.51073 12.0656L14.0402 20.6519C14.8011 21.4178 14.8011 22.6596 14.0402 23.4256C13.2794 24.1915 12.0457 24.1915 11.2849 23.4256ZM14.3009 12.4032L11.4331 15.2901L8.67771 12.5165L11.5456 9.62951C12.3065 8.86357 13.5401 8.86358 14.3009 9.62951C15.0618 10.3954 15.0618 11.6373 14.3009 12.4032Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const FaktionLogoTypeIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => {
  const aspectRatio = 98 / 24; // Calculate the aspect ratio of the original SVG
  const height = size / aspectRatio; // Calculate the height based on the aspect ratio
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M22.498 6.12881H30.6893V6.12976L30.672 7.95472H24.5545V11.432H30.0969V13.2399H24.5545V18.1817H22.498V6.12881ZM43.5713 18.1827H41.3747V18.1817L40.2073 15.4604H34.0552L32.8878 18.1817H30.744L36.129 6.12881H38.2372L43.5713 18.1827ZM37.1217 8.29809L34.8213 13.6535H39.4229L37.1217 8.29809ZM50.7689 11.2784L55.8054 18.1827L55.8034 18.1808H53.3294L49.3211 12.8605L47.2474 15.1161V18.1817H45.191V6.12881H47.2474V12.3616L53.0682 6.12881H55.4914L50.7689 11.2784ZM56.6377 6.12881H66.415V7.95472H62.546V18.1817H60.4905V7.95377H56.6377V6.12881ZM68.3649 6.12881H70.4213V18.1817H68.3649V6.12881ZM72.6179 12.1558C72.6179 8.69457 75.4415 6.07759 79.0839 6.07759C82.7254 6.07759 85.5499 8.7126 85.5499 12.1558C85.5499 15.5989 82.7264 18.2681 79.0839 18.2681C75.4415 18.2681 72.6179 15.6169 72.6179 12.1558ZM83.4417 12.1558C83.4417 9.76167 81.4889 7.90255 79.1012 7.90255C76.6963 7.90255 74.7099 9.76262 74.7099 12.1558C74.7099 14.5489 76.7136 16.4431 79.1012 16.4431C81.4889 16.4431 83.4417 14.5498 83.4417 12.1558ZM95.9781 6.12881H98V18.1827H95.9781L89.4775 9.53876V18.1817H87.4211V6.12881H89.443L95.9781 14.7898V6.12881Z"
        fill="currentColor"
      />
    </svg>
  );
